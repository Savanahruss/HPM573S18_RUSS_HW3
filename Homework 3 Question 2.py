...
class Node:
    ...
    def get_expected_healthutility(self):
        raise NotImplementedError("This is an abstract method and needs to be implemented in derived classes")
...
class ChanceNode(Node):
    ...
    def get_expected_healthutility(self):
        ...
        """
        exp_health = self.health
        i = 0
        for node in self.futureNodes:
            exp_health += self.probs[i]*node.get_expected_healthutility()
            i += 1
        return exp_health
...
class TerminalNode(Node):
    ...
    def get_expected_healthutility(self):
        """
        :return: health utility of this chance node
        """
        return self.health
...
class DecisionNode(Node):
    ...
    def get_expected_healthutility(self):
        """return the expected health utility of future nodes"""
        expected_health = dict()
        for node in self.futureNode:
            expected_health[node.name] = node.get_expected_healthutility()
...
#Print the expected health utility of C1 and C3
print(D1.get_expected_healthutility())